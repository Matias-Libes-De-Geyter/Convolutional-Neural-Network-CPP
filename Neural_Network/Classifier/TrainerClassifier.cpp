...
// ======== TRAINER CLASSIFIER ======== //
TrainerClassifier::TrainerClassifier(CNN& model, const hyperparameters& hyper) : _model(model), _hyper(hyper) {
	_scope = nullptr;
	_xtrain = nullptr;
	_ytrain = nullptr;
	_xvalid = nullptr;
